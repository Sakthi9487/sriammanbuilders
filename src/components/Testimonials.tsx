...
const testimonials = [
    { id: 1, name: 'Thanigachalam', position: 'Thasildar', company: 'Tirupattur', rating: 5, text: 'Sri Amman Builders delivered our residential complex project with exceptional quality and professionalism. Their attention to detail and commitment to deadlines is remarkable.' },
    { id: 2, name: 'Manivannan', position: 'School Principal', company: 'Adiyur', rating: 5, text: 'Working with Sri Amman Builders for our building was a fantastic experience. They managed the entire project seamlessly and delivered beyond our expectations.' },
    { id: 3, name: 'Dhatchanamoorthy', position: 'Software Engineer', company: 'Pudupettai', rating: 5, text: 'The residential facility they built for us is outstanding. The quality of construction and their project management skills are top-notch. Highly recommended!' },
    { id: 4, name: 'Arumugam', position: 'School Principal', company: 'Pudur Nadu', rating: 5, text: 'Our dream home became a reality thanks to their team. They were professional, responsive, and delivered exactly what we envisioned for our family.' }
];
    ...
    return (
        <section id="testimonials" className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    <span className="text-orange-500 text-lg font-semibold uppercase tracking-wider">Client Testimonials</span>
