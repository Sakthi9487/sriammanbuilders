      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Sri Amman Builders delivers exceptional construction services
          ...
          >
            {[
              { icon: Award, value: '61+', label: 'Projects Completed' },
              { icon: Users, value: '61+', label: 'Happy Clients' },
              { icon: Calendar, value: '15+', label: 'Running Projects' },
            ].map((stat, index) => (
              <motion.div
                key={index}
