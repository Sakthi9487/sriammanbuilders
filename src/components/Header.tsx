      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          <div onClick={() => scrollToSection('home')} className="cursor-pointer flex items-center group">
            <img src="/ammanbuilders.png" alt="Sri Amman Builders Logo" className="h-16 w-auto" />
            <div className={`hidden md:flex flex-col ml-2 transition-colors duration-300 ${isScrolled ? 'text-gray-800' : 'text-white'}`}>
              <span className="font-extrabold text-xl leading-tight group-hover:text-orange-500 transition-colors duration-300">Sri Amman</span>
              <span className="text-sm tracking-widest group-hover:text-orange-500 transition-colors duration-300">Builders</span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <a href="tel:+919894885441" className={`flex items-center transition-colors duration-300 hover:text-orange-500 ${isScrolled ? 'text-gray-700' : 'text-white'}`}>
              <Phone size={18} className="mr-2" />
              <span className="text-sm font-medium">+91 98948 85441</span>
            </a>
            <motion.button
