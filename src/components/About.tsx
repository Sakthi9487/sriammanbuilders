      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div variants={itemVariants}>
            <div className="mb-8">
              <span className="text-orange-500 font-semibold text-lg uppercase tracking-wider flex items-center">
                <div className="w-12 h-0.5 bg-orange-500 mr-2"></div>
                About Us
              </span>
              <h2 className="text-4xl font-bold text-gray-800 mt-4 mb-6">
                Er. K. Selvanathan, M.E., MBA
                <span className="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-700 block">
                  Registered Structural Engineer | 2D Plan & 3D Design Specialist | Material Contractor
                </span>
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                Er. K. Selvanathan is a DTCP Approved Registered Structural
                Engineer with over 7 years of experience in the construction
                industry in Tirupattur. He specializes in structural design, 2D
                planning, 3D architectural modeling, and complete construction
                solutions.He currently serves as the Joint Secretary of the Tirupattur Civil
                Engineers Association, contributing actively to the professional
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div
                className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300 group"
                variants={itemVariants}
              >
                ...
                <p className="text-gray-600 text-sm">
                  To deliver outstanding construction solutions that exceed
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  To be india's leading construction company, known for
                  innovation, sustainability, and creating spaces that enhance
                  communities.
                </p>
              </motion.div>
            </div>
