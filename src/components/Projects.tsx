        ...
        const fallbackData = [
          {
            ...
            location: "DHA Phase 6, Tamilnadu",
            value: "$2.5M",
            duration: "18 Months",
            images: [
    ...
    <section id="projects" className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <span className="text-orange-500 font-semibold text-lg uppercase tracking-wider flex items-center justify-center">
